...
const componentsByPath = {
    ...
    "home": {name: "Home", projectId: "t7iishVHzzmwtanur9Xcox" },
  
    "pricing": {name: "Pricing", projectId: "t7iishVHzzmwtanur9Xcox" },
  
    "features": {name: "Features", projectId: "t7iishVHzzmwtanur9Xcox" },
